      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-8 max-w-2xl">
        ...
        >
          <a
            ...
            className="px-8 py-3 bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-full transition-all duration-300 hover:scale-105"
          >
            ✉️ Email Me
          </a>
          ...
          <a
            ...
            className="px-8 py-3 border border-white/40 hover:border-blue-400 hover:text-blue-400 text-white font-semibold rounded-full transition-all duration-300 hover:scale-105"
          >
            💼 LinkedIn
          </a>
        </motion.div>
