    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 w-full z-50 grid grid-cols-3 items-center px-8 py-4 transition-all duration-300 ${
          scrolled ? "border-b border-white/10 bg-black/20 backdrop-blur-md" : "border-b border-white/5"
        }`}
      >
        {/* Left — Name */}
        <motion.span
        ...
        {/* Center — Floating Pill (hidden on mobile) */}
        <motion.div
        ...
        {/* Right — Glow Button (hidden on mobile) + Hamburger (visible on mobile) */}
        <div className="justify-self-end flex items-center gap-4">
          ...
          <motion.a
            ...
            transition={{ delay: 0.2, duration: 0.5 }}
            whileHover={{
              boxShadow: "0 0 24px rgba(0, 100, 255, 0.6), inset 0 0 16px rgba(0, 100, 255, 0.1)",
            }}
            ...
            style={{
              boxShadow: "0 0 12px rgba(0, 100, 255, 0.3), inset 0 0 12px rgba(0, 100, 255, 0.05)",
            }}
          >
            Let's Talk ✦
          </motion.a>
